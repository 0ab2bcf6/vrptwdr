...
//	private LinkedList<RouteNode> listRoute;
//
...
//	}
//
//	public LinkedList<RouteNode> getRoute() {
//		return listRoute;
//	}
//
//	public RouteNode getLastRouteNodeOfRoute() {
//		return listRoute.getLast();
//	}
//
...
//
//			// if insertPosition is at the end
//			Node prev = listRoute.getLast().getNode();
...
//
//		LinkedList<Node> listRemovedNodes = new LinkedList<>();
//		LinkedList<Node> rvisits = mapRobotVisits.get(indexRouteNode);
//
//		if (rvisits != null && rvisits.size() != 0) {
...
//
//			cost = 0;
//			vantime = listRoute.getLast().getReadyTime();
//
...
//
//			this.cost = currentInstance.getTravelingTimeVehicle(listRoute.getLast().getId(),
//					listRoute.getFirst().getId());
//
